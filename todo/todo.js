...
var todosElem = (React.createElement("section", {"$class": "main", "$hide": numTodos.is(0)}, React.createElement("input", {"$class": "toggle-all", "id": "toggle-all", "type": "checkbox", "checked": allCompleted, "onchange": function () { return todos.swap(markAll, !allCompleted.get()); }}), React.createElement("label", {"htmlFor": "toggle-all"}, "Mark all as ", allCompleted.then('in', ''), "complete"), React.createElement("ul", {"$class": "todo-list"}, caching_1.ucmap(function (x) { return x.get('id'); }, renderTodo, todos))));
